    ...
    <>
      ...
      >
        <Box sx={{ display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
          <List>
            <ListItem component={Link} to={RuoteEnum.Dashboard} sx={{ color: 'inherit' }} onClick={drawerToggle}>
              <ListItemIcon>
                <Book />
              </ListItemIcon>
              <ListItemText primary={Strings.todaysBlink} />
            </ListItem>
            <Divider style={{ margin: '0 auto', width: '65%' }} />
            <ListItem component={Link} to={RuoteEnum.Library} sx={{ color: 'inherit' }} onClick={drawerToggle}>
              <ListItemIcon>
                <LibraryBooks />
              </ListItemIcon>
            ...
            <Divider style={{ margin: '0 auto', width: '65%' }} />
            <ListItem component={Link} to={RuoteEnum.Highlights} sx={{ color: 'inherit' }} onClick={drawerToggle}>
              <ListItemIcon>
                <BookmarkSingle />
              </ListItemIcon>
